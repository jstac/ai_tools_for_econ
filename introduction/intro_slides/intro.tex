...
\begin{frame}
    ...
    An AI agent that evolves complex algorithms and entire codebases using LLMs

        \vspace{0.5em}
    Employs an evolutionary algorithm

        \vspace{0.5em}
    Asks an ensemble of LLMs and then iteratively generates, tests, and refines

        \vspace{0.5em}
    Promising solutions are selected and mutated by LLMs to create
    new candidates, fostering a ``survival of the fittest" to progressively improve performance
