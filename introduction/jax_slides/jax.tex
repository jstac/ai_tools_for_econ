...
\begin{frame}
    ...
    \begin{enumerate}
        \item Arrays are defined in a high-level interface
        \vspace{0.5em}
...
\begin{frame}
    ...
    \vspace{0.5em}
    \begin{itemize}
        \item Operations are passed to specialized to machine code 
        \vspace{0.5em}
    ...
    \begin{itemize}
        ...
        \vspace{0.5em}
        \item Fails to specialize on array \emp{shapes}
        \vspace{0.5em}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Automatic differentiation
            \vspace{0.5em}
        \item Accelerated linear algebra
    \end{itemize}
    ...
    \pause
    \begin{itemize}
        \item significant advantages over C / Fortran / NumPy / Julia / Numba 
        \item But is not uniformly ``better'' --- discuss later
    \end{itemize}
...
\begin{frame}
    ...
    Advantages for JAX:
     ...
     \begin{itemize}
         \item Pure functions are easier to differentiate (don't modify external state)
    \vspace{0.5em}
