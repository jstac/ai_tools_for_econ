...
\begin{frame}{Universal function approximation I}
    ...
    \textbf{Theorem}. (Cybenko--Hornik) Let 
    %
    \begin{itemize}
...
\begin{frame}{Universal function approximation II}
    ...
    %
    \begin{equation*}
        \int_{\RR^n} |f(x) - g(x)| \diff x < \varepsilon
    \end{equation*}
    %
...
\begin{frame}
    ...
    approximation property
            ...
            \vspace{0.4em}
    \begin{itemize}
        \item \brown{polynomials} in the set of continuous functions on compacts 
            \vspace{0.4em}
        \item any \brown{complete orthonormal basis} in a Hilbert space
            \vspace{0.4em}
        \item \brown{SVMs} with RBF kernels in reproducing kernel Hilbert space
            \vspace{0.4em}
        \item \brown{Gaussian processes} with RBF kernels in the set of continuous
            functions on compacts
            \vspace{0.4em}
