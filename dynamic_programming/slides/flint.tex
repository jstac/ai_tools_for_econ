...
\node (v) [right=70pt of s] {$v_{\sigma} = (I - L_\sigma)^{-1} r_\sigma$};
\node (v1) [below of=v] {$v_{\sigma'} = (I - L_{\sigma'})^{-1} r_{\sigma'}$};
\node (el2) [below of=v1] {$\vdots$};
\node (v2) [below of=el2] {}; %$v_{\sigma^*} = (I - L_{\sigma^*})^{-1} r_{\sigma^*}$};
